...
process_bo_data = function(BO_layer, proj = newproj, area = aoi, mask = eez_gulf) {
  
  #reproject
  layer_proj <- projectRaster(BO_layer, crs = proj)
...
# reproject
depth_proj <- projectRaster(depth, crs = newproj)
